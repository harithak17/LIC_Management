    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="pageAdminLAReport" class="active">
              ...
              <table class="table table-borderless datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">No of Policy<br>holders</th>                        
                  </tr>
                </thead>
                <tbody>
                  <c:forEach var="entry" items="${countMap}">                       
                        <tr>
                            <th scope="row"><a href="#">${entry.key.agentEmpId}</a></th>
                            <td>${entry.key.agentName}</td>
                            <td>${entry.key.agentLoc.locName}</td>
                            <td>${entry.key.agentMob}</td>
                            <td>${entry.key.agentEmail}</td>
                            <td>${entry.value}</td>
                          </tr> 
                   </c:forEach>                    
                </tbody>
