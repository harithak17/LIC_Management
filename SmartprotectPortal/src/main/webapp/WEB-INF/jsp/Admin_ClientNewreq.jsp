  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="col-lg-12">            
          <div class="card">
            <div class="card-body">            
              <h5 class="card-title">Policy Holder Requests</h5> 
              <table class="table table-borderless">
                ...
                <c:forEach var="r" items="${newreqList}">             
                <tr>
                    <td>${r.clientPolicy.policyName}</td>
                    <td>${r.agent_id.agentName}</td>
                    <td>${r.clientName.clientName}</td>                    
                    <td><a href="pageAdminClientNewreqApprv${r.regId}">View Client Details</a></td> 
                    <td></td>  
                    <td></td>                 
                </tr>
                </c:forEach>
