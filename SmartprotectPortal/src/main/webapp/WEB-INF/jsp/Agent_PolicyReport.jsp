...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="pageAgentHome">Policies</a></li>
          ...
          <div class="row">   
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">               
                <div class="card-body">
                  <h5 class="card-title">Policy Reports</h5>        
                   <table class="table table-borderless datatable">
                    ...
                    <tbody> 
                       <c:forEach var="entry" items="${countMap}">                       
                        <tr>
                            <th scope="row"><a href="#">${entry.key.policyCode}</a></th>
                            <td>${entry.key.policyCategory.catName}</td>
                            <td>${entry.key.policyName}</td>
                            <td>${entry.value}</td>
                          </tr> 
                        </c:forEach>  
                    </tbody>
