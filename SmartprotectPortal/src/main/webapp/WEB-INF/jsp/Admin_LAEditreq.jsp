    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="pageAdminLAEdit" class="active">
          ...
          <div class="card">
            <div class="card-body">            
              ...
              <table class="table table-borderless datatable">
                ...
                <tbody>
                <c:forEach var="la" items="${agentList}">
                	<c:choose>
                		<c:when test="${la.status != 0}">
                 			 <tr>
                    			<th scope="row"><a href="#">${la.agentEmpId}</a></th>
                    			<td>${la.agentName}</td>
                    			<td>${la.agentLoc.locName}</td>
                    			<td>${la.agentMob}</td>
                    			<td>
                   	 				<c:if test="${la.status == 1}">
                    					<span class="badge bg-success">Approved</span>
                    				</c:if>	
                    				<c:if test="${la.status == 2}">
                    					<span class="badge bg-warning">Pending</span>
                    				</c:if>
                    				<c:if test="${la.status == 3}">	
                    					<span class="badge bg-danger">Rejected</span>
                    				</c:if>	
                    			</td>
                    			<td><a href="/agentProfile${la.agentId}" class="text-primary">Edit</a></td>
                    			<!--  <td><a href="#" class="text-primary">Delete</a></td> -->
                 			 </tr> 
                  		</c:when>
                  </c:choose>
                 </c:forEach>                      
