...
<body>
            ...
            <div class="card-body">              
              ...
              <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">              
                <div class="carousel-inner">
                  <c:forEach var="agent" items="${newReqList}">
                  <div class="carousel-item active">
                    <h5 class="card-title">${agent.agentName} | ${agent.agentEmpId} &nbsp;&nbsp;&nbsp;&nbsp;<span class="text-success small pt-1 fw-bold"><a href="/agentProfile${agent.agentId}"><u>View Details</u></a></span></h5>
                    <img src="${agent.agentPhotopath}" class="d-block w-100" alt="${agent.agentPhotopath}">  
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      <a href="pageAdminHome">www.smartprotect.com</a>
    </div>
  </footer><!-- End Footer -->
