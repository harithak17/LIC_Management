...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="pageAdminClientNew" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Policies Holders Requests</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Policy Holders</a></li>
                    ...
                    <div class="card info-card customers-card">
                      <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                         <form:form action="sendclientResponse" method="post" modelAttribute="newreqItem">
                         <form:hidden path="regId"/>
                          <table class="table table-borderless">
                              <tr>
                                  <td><b>Client Name:</b></td>
                                  <td><form:label path="clientName">${newreqItem.clientName.clientName}</form:label></td>
                                  <td></td>
                              </tr>
                              <tr>
                                <td><b>Email Id:</b></td>
                                <td><form:label path="clientName.clientEmail">${newreqItem.clientName.clientEmail}</form:label></td>  
                                <td></td>
                              </tr>
                              <tr>
                                <td><b>DOB:</b></td>
                                <td><form:label path="clientName.clientDob">${newreqItem.clientName.clientDob}</form:label></td>
                                <td></td>
                              </tr>
                              <tr>
                                <td><b>Gender:</b></td>
                                <td><form:label path="clientName.clientGen">${newreqItem.clientName.clientGen}</form:label></td>
                                <td></td>
                              </tr>
                              <tr>
                                <td><b>Address</b></td>
                                <td><form:label path="clientName.clientAddr1">${newreqItem.clientName.clientAddr1}</form:label>
                                <form:label path="clientName.clientAddr2">${newreqItem.clientName.clientAddr2}</form:label>
                                <form:label path="clientName.clientCity">${newreqItem.clientName.clientCity}</form:label>
                                <form:label path="clientName.clientPin">${newreqItem.clientName.clientPin}</form:label> </td>                               
                              </tr>                             
                              <tr>
                                <td><b>Client Id:</b></td>
                                <td><form:label path="clientName.clientUID">${newreqItem.clientName.clientUID}</form:label></td>
                                <td></td>
                              </tr>                            
        ...
        <div class="col-lg-4">
            ...
            <div class="card">              
              <div class="card-body">
                ...
                <div class="activity">
                   <img src="${newreqItem.clientName.clientPhotopath}" alt="" width="100px" height="100px" />
                </div> 
                <h5 class="card-title">Identification Proof</h5>  
                <div class="activity">
                    <embed src="${newreqItem.clientName.clientProofpath}" width="250px" height="250px" />
                </div>  
              </div>
            </div>         
