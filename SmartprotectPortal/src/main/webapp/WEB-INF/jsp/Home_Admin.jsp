...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="pageIndex">Home</a></li>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">        
                ...
                <div class="card-body">
                  <h5 class="card-title">Messages <a href=""><span style="color: red;"><u>New</u></span></a></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>${msgAll}</h6>
                      <span class="text-success small pt-1 fw-bold"><a href="pageAdminInbox"><u>View all</u></a></span>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                <div class="card-body">
                  <h5 class="card-title">Agent Requests<a href="pageAdminLANew"> <span style="color: red;"><u>New ${agentNew}</u></span></a></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>${agentAll}</h6>
                      <span class="text-success small pt-1 fw-bold"><a href="pageAdminLAReport"><u>View all</u></a></span> 
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                <div class="card-body">
                  <h5 class="card-title">Policy Holders Requests <a href="pageAdminClientNew"><span style="color: red;"><u>New ${clientNew}</u></span></a></h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    ...
                    <div class="ps-3">
                      <h6>${clientAll}</h6>
                      <span class="text-success small pt-1 fw-bold"><a href="pageAdminClientNew"><u>View all</u></a></span> 
                    </div>
                  </div>
                </div>
              </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      <a href="index.html">www.smartprotect.com</a>
    </div>
  </footer><!-- End Footer -->
