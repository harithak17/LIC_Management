...
$(document).ready(function () {
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        document.getElementById("modalForm").action="delCatById/"+$(event.relatedTarget).attr('data-id');
    });
});
</script>
  <!-- =======================================================
                ...
                <div class="card-body">
                  ...
                  <form:form action="${action}" method="post" modelAttribute="category">
                    <table class="table table-borderless">
                        <tr>
                            <td>Category Name</td>
                            <td><form:input path="catName" type="text"  />
                            <button class="btn btn-primary btn-sm" type="submit">
                                Save
                              </button></td>
                              <td></td>
                              <form:input path="catId" type="text" style="display:none"/>
                        </tr>
                        <tr>
                        	<td></td>
                  ...
                  <h5 class="card-title">Category List</h5>        
                   <table class="table table-borderless datatable">
                    ...
                    <c:forEach var="cat" items="${catList}">
                      <tr>
                        <td>${cat.customCode}</td>
                        <td>${cat.catName}</td>
                        <td><a class="text-primary" href="/${cat.catId}">Edit</a></td>
                        <td><a class="text-primary" data-id="${cat.catId}" data-toggle="modal" data-target="#exampleModal" href="#exampleModal">Delete</a></td>
