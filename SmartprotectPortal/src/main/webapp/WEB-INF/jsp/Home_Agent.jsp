          ...
          <div class="row">           
            ...
            <div class="col-xxl-4 col-xl-12">
              <div class="card info-card customers-card">
                <div class="card-body">
                  <h5 class="card-title">My Clients Details <a href=""></a></h5>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>${clientCount}</h6>
                      <span class="text-success small pt-1 fw-bold"><a href="pageClientList"><u>View all</u></a></span> 
                    </div>
                  </div>
                </div>
              </div>
           ...
           <div class="row">           
            ...
            <div class="col-xxl-4 col-xl-12">
              <div class="card info-card customers-card">
                <div class="card-body">
                  <h5 class="card-title">My Policies Reports</h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <i class="bi bi-people"></i>
                    </div>
                    <div class="ps-3">
                      <h6>${policyCount}</h6>
                      <span class="text-success small pt-1 fw-bold"><a href="pagePolicyReports"><u>View all</u></a></span> 
                    </div>
                  </div>
                </div>
              </div>
