          ...
          <div class="row">   
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">               
                <div class="card-body">
                  <h5 class="card-title">Registered Policy Holders</h5>        
                   <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row"><a href="#">${entry.key.clientId}</a></th>
                            <td>${entry.key.clientName}</td>
                            <td>${entry.key.clientEmail}</td>
                            <td>${entry.key.clientMob}</td>
                            <td>${entry.value}</td>
                            <td><a href="editClientProfile${entry.key.clientId}">Edit</a></td>
                          </tr> 
                         </c:forEach>
                    </tbody>
                  </table>
