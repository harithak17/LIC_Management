    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="pageAdminPolicyNew" class="active">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="col-lg-10">            
          <div class="card">
            <div class="card-body">            
              <h5 class="card-title">Create New Policy</h5>  
              <form:form action="savePolicy" method="post" modelAttribute="policy" enctype="multipart/form-data">
              <table class="table table-borderless">
                ...
                <tr>
                    <td>Description</td>
                    <td><input type="file" class="form-control" required="required" name="file1" accept="application/pdf"></td>                  
